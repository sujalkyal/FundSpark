...
const Navbar = () => {
  ...
  return (
    <nav className='bg-gradient-to-r from-blue-700 to-slate-900 text-white flex justify-between  items-center px-4 md:h-16 flex-col md:flex-row'>
      <Link href={'/'} className='logo flex items-center justify-center gap-2 logo font-bold text-lg'>
        <img src="icons/coins.gif" width={40} alt="" />
        <span className='md:text-xl text-2xl'>Fund Spark</span>
      </Link>
      ...
      <div className='relative'>
        ...
        {!session && <Link href={"/login"}>
          <button className='text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2 text-center me-2 mb-2 my-2' >Login</button>
        </Link>}
      </div>
