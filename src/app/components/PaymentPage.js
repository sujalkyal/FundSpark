            ...
            {loading ? (
                ...
                <>
                    ...
                    <div className='info flex justify-center items-center mt-10 mb-10 md:mt-20 md:mb-24 flex-col'>
                        ...
                        <div className='text-slate-400'>Let's help {username} fund their Spark</div>
                    ...
                    <div className='flex items-center justify-around'>
                        <div className=" payment flex justify-center gap-5 w-[95%] mb-11 flex-col md:flex-row">
                            <div className="bg-opacity-35 supporters w-full md:w-1/2 bg-slate-900 rounded-lg text-white p-10">
                            ...
                            <div className="bg-opacity-35 makePayment w-full md:w-1/2 bg-slate-900 rounded-lg text-white p-10">
                                ...
                                <div className="flex gap-5 mt-5 justify-center">
                                    <button className=' group bg-gradient-to-br from-cyan-500 to-blue-500 group-hover:from-cyan-500 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-cyan-200 dark:focus:ring-cyan-800 p-3 rounded-lg' onClick={() => { pay(1000) }}>Pay ₹10</button>
                                    <button className='group bg-gradient-to-br from-cyan-500 to-blue-500 group-hover:from-cyan-500 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-cyan-200 dark:focus:ring-cyan-800 p-3 rounded-lg' onClick={() => { pay(10000) }}>Pay ₹100</button>
                                    <button className=' group bg-gradient-to-br from-cyan-500 to-blue-500 group-hover:from-cyan-500 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-cyan-200 dark:focus:ring-cyan-800 rounded-lg p-3' onClick={() => { pay(50000) }}>Pay ₹500</button>
                                    <button className='group bg-gradient-to-br from-cyan-500 to-blue-500 group-hover:from-cyan-500 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-cyan-200 dark:focus:ring-cyan-800 rounded-lg p-3' onClick={() => { pay(100000) }}>Pay ₹1000</button>
                                </div>
                            </div>
                        </div>
                    </div>
